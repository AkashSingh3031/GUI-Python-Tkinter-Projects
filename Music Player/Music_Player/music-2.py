...
def createwidthes():
    ...
    # #==============================Image Path==================================
    immute = PhotoImage(file = 'C:\\Users\\Akash Singh\\Documents\\Coding\\Python Program\\Projects\\GUI Project\\Music Player\\Music_Player\\images\\mute.png')
    imunmute = PhotoImage(file = 'C:\\Users\\Akash Singh\\Documents\\Coding\\Python Program\\Projects\\GUI Project\\Music Player\\Music_Player\\images\\volume_down.png')
    implay = PhotoImage(file = 'C:\\Users\\Akash Singh\\Documents\\Coding\\Python Program\\Projects\\GUI Project\\Music Player\\Music_Player\\images\\play.png')
    imstop = PhotoImage(file = 'C:\\Users\\Akash Singh\\Documents\\Coding\\Python Program\\Projects\\GUI Project\\Music Player\\Music_Player\\images\\stop.png')
    impause = PhotoImage(file = 'C:\\Users\\Akash Singh\\Documents\\Coding\\Python Program\\Projects\\GUI Project\\Music Player\\Music_Player\\images\\pause.png')
    imresume = PhotoImage(file = 'C:\\Users\\Akash Singh\\Documents\\Coding\\Python Program\\Projects\\GUI Project\\Music Player\\Music_Player\\images\\resume.png')
    imbrowse = PhotoImage(file = 'C:\\Users\\Akash Singh\\Documents\\Coding\\Python Program\\Projects\\GUI Project\\Music Player\\Music_Player\\images\\search.png')
    imvolumeup = PhotoImage(file = 'C:\\Users\\Akash Singh\\Documents\\Coding\\Python Program\\Projects\\GUI Project\\Music Player\\Music_Player\\images\\volume_up.png')
    imvolumedown = PhotoImage(file = 'C:\\Users\\Akash Singh\\Documents\\Coding\\Python Program\\Projects\\GUI Project\\Music Player\\Music_Player\\images\\volume_down.png')
    ...
    Browse_Button.grid(row=1, column=2, padx=20, pady=20)
    ...
    root.Pause_Button.grid(row=4, column=1, padx=20, pady=20)
    ...
    root.Resume_Button.grid(row=4, column=1, padx=20, pady=20)
    root.Resume_Button.grid_remove()
    ...
    Progressbar_lbl.grid(row=1, column=3, rowspan=3)
    Progressbar_lbl.grid_remove()

    progressbar_volume = Progressbar(Progressbar_lbl, orient=VERTICAL, mode="determinate", value=40, length=190)
...
Slider_Label.grid(row=5, column=0, padx=20, pady=20, columnspan=31)
